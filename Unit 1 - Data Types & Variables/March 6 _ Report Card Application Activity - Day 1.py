...
#asks user for user to input information
...
def calculate_class_average(mathGrade, englishGrade, computerGrade):
    #calculates the average of the three grades; math, english, cs
...
print("Current marks for ", nameFirst, nameLast, ":\n")
...
#check if the class average is 70 percent
if class_average == 70:
    print("The class average is exactly 70 percent.\n")
elif class_average > 70:
    print("The class average is above 70 percent.\n")
else:
    print("The class average is below 70 percent.\n")

print("All student reports are to be returned to: WESTERN TDSB")
